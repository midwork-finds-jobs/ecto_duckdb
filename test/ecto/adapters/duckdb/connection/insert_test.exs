defmodule Ecto.Adapters.DuckDB.Connection.InsertTest do
  ...
  test "insert" do
    ...
    assert_raise ArgumentError, "DuckDB does not support table prefixes", fn ->
  ...
  test "insert with on conflict" do
    ...
    assert_raise ArgumentError, "Upsert in DuckDB requires :conflict_target", fn ->
      conflict_target = []
    ...
    assert_raise ArgumentError,
                 "Upsert in DuckDB does not support ON CONSTRAINT",
                 fn ->
                   insert(
                     nil,
                     "schema",
