defmodule Ecto.Adapters.DuckDB.Connection.JoinTest do
  ...
  alias EctoDuckDB.Schemas.Schema2
  ...
  test "join with hints are not supported" do
    assert_raise Ecto.QueryError, ~r/join hints are not supported by DuckDB/, fn ->
      Schema
