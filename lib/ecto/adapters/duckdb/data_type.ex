defmodule Ecto.Adapters.DuckDB.DataType do
  ...
  # Column type mappings for DuckDB. DuckDB has a rich type system but we
  # maintain compatibility with common Ecto types.
  ...
  # Native datetime types - DuckDB supports DATE, TIME, TIMESTAMP, and TIMESTAMPTZ
  ...
  def column_type(:utc_datetime, _opts), do: "TIMESTAMPTZ"
  def column_type(:utc_datetime_usec, _opts), do: "TIMESTAMPTZ"
